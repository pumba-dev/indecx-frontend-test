<template>
  <v-main class="d-flex flex-row align-center justify-center h-screen">
    <v-card
      class="d-flex flex-column rounded-xl pa-15 align-center justify-center w-25"
      min-width="500"
    >
      <v-img
        width="220"
      ...
      >
        ...
        <v-btn
          ...
          block
          class="bg-primary fill-height rounded h-10 pa-4 font-weight-medium"
